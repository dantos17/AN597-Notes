...
we're strting by creating our own dataset of correlated random normal continuous variables
```{r creating datasets}
...
summary(m3) #mine do not match his at ALL, could the ones in the module still be standardised?
```
