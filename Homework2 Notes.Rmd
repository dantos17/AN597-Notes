...
I could do a sum but there's no upper limit. (This code didn't work at all so there's no point in putting it in an R chunk)
...
I didn't get any warnings so I'm assuming this is good
